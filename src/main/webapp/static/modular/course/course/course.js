...
Course.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '课程号', field: 'courseNum', visible: true, align: 'center', valign: 'middle'},
            {title: '课程名', field: 'courseName', visible: true, align: 'center', valign: 'middle'},
            {title: '课时', field: 'courseTimespan', visible: true, align: 'center', valign: 'middle'},
            {title: '学分', field: 'coursePoint', visible: true, align: 'center', valign: 'middle'}
    ];
};
